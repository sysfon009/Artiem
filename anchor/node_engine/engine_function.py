...
async def generate(
    ...
    if custom_tools and isinstance(custom_tools, list):
        print(f"[DEBUG] Custom Tools Injected: {len(custom_tools)} tools.")
    ...
    if using_custom_tools:
        print("[DEBUG] Tool: Code Execution -> FORCED OFF (Custom Tools Active)")
    elif config.get("use_code_execution"):
        ...
        try:
            ...
            async for chunk in response_stream:
                ...
                for cand in chunk.candidates:
                    ...
                    # Kita cari signature SEBELUM masuk ke loop parts.
                    # =========================================================
                    extracted_signature = None
                    
                    # CARA 1: Cek langsung di object Candidate (Level teratas)
                    ...
                    if extracted_signature:
                        try:
                            ...
                            print(f"\033[93m[ENGINE] !!! SIGNATURE FOUND !!! Len: {len(final_sig_str)}\033[0m")
                        except Exception as e:
                            print(f"[ENGINE] Signature Decode Error: {e}")
                    ...
                    for part in cand.content.parts:
                        try:
                            ...
                            if part.function_call:
                                ...
                                yield _attach_sig({
                                    "type": "function_call",
                                    "content": {"name": fc_name, "args": args_dict}
                                })
            ...
            print(f"[ENGINE_WARN] Attempt {attempt+1} failed: {e}")
